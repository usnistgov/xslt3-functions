...
call mvn --quiet -f %APPLICATION_DIR%pom.xml exec:java -Dexec.mainClass="com.xmlcalabash.drivers.Main" -Dexec.args="-omd=%HEREPATH%/manifest.md -ohtml=NUL %APPLICATION_DIR%/directory-manifest.xpl path=%HEREPATH%"
